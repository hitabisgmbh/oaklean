...
describe('NodeModuleUtils', () => {
	...
	describe('getParentModuleFromPath', () => {
		test('valid module path', () => {
			expect(
				NodeModuleUtils.getParentModuleFromPath(
					new UnifiedPath('path/to/node_modules/module/file/in/module')
				)?.toString()
		...
		test('invalid module path', () => {
			expect(
				NodeModuleUtils.getParentModuleFromPath(
					new UnifiedPath('path/to/node_m0dules/module/file/in/module')
				)?.toString()
			).toBeUndefined()
		})
		...
		test('scoped module path', () => {
			expect(
				NodeModuleUtils.getParentModuleFromPath(
					new UnifiedPath('path/to/node_modules/@hitabis/module/file/in/module')
				)?.toString()
