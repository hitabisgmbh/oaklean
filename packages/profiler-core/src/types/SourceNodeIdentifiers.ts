...
export const SourceNodeIdentifierPartSymbol: unique symbol = Symbol(
	'SourceNodeIdentifierPartSymbol'
)
export type SourceNodeIdentifierPart_string = string & {
	[SourceNodeIdentifierPartSymbol]: never
}
